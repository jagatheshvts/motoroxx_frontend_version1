...
import { MessageAlertsTemplatesComponent } from './message-alerts-templates/message-alerts-templates.component';
...
const routes: Routes = [
      ...
      {
        path: 'message-alerts-templates',
        component: MessageAlertsTemplatesComponent
      }
