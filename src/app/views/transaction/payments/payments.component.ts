    ...
    this.LocalStoreService.sup_transbyid(selectedItem._id).subscribe(data => {
      ...
      if (data.response.length > 0) {
        ...
        objectdatapay.transaction.forEach(data => {
          if (data.receipttransaction.totalreceipt_amount) {
            receipt += data.receipttransaction.totalreceipt_amount
          }
          if (data.receipttransaction.payment) {
            payment += data.receipttransaction.payment
          }
        })
