...
@Component({
  selector: 'app-closedjobcards',
  // standalone: true,
  // imports: [],
  templateUrl: './closedjobcards.component.html',
  styleUrl: './closedjobcards.component.scss',
  providers: [DatePipe]
})
export class ClosedjobcardsComponent implements OnInit {
  ...
  oninitclick(){
    ...
    var status = "datewise_totalgst_closed-report"
  ...
  onDatepickerClosed(): void {
    ...
    if(startdate === enddate ){
      ...
      var status = "rangewise_totalgst_closed-report"
